...
// void Display(PNODE First){            //Head Recursion
//   if (First != NULL){
//     printf("%d| ->",First->data);
//     Display(First -> next);
//   }
...
// It will print in reverse order, recall the stack frames
void Display(PNODE First){            // Tail Recursion
  if (First != NULL){
    Display(First -> next);
    printf("%d| ->",First->data);
  }
...
int main (){
  ...
  InsertLast(&Head, 151);
  Display (Head);
  printf("Total Elements: %d", Count(Head));
